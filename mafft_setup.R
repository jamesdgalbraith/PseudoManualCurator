...
# determine queries
queries <- read_tsv(paste0("out/", opt$genome_name, "_self_queries.txt"), col_names = "qseqid", show_col_types = F)
...
write_tsv(to_align, paste0("out/", opt$genome_name, "_to_align.txt"), col_names = F)
